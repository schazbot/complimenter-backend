...
Compliment.create(content:"You’re really well-read, baby.")
...
Compliment.create(content:"Serving FACE.")
Compliment.create(content:"Be your authentic self, show the world who you are!")
Compliment.create(content:"Love love LOVE")
